...
void P1 (void const *argument) {
	for (;;) 
	{
		...
		osThreadSetPriority(t_P3, osPriorityHigh); //**solution uncomment - the priority thread of P3 is set high and reverted back later
		...
		osThreadSetPriority(t_P3,osPriorityBelowNormal); //**solution uncomment - here it is reverted back to low priority
		LED_On(6);
		LED_Off(6);
	}
}
